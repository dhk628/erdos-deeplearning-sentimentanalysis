...
def evaluate_model(y_test, y_pred, y_prob):
    results = {'model': 'logreg',
               ...
               'log_loss': log_loss(y_test, y_prob) if y_prob else 'na',
               'f1_weighted': f1_score(y_test, y_pred, average='weighted'),
               'f1_macro': f1_score(y_test, y_pred, average='macro'),
               'f1_micro': f1_score(y_test, y_pred, average='micro'),
               'roc_auc_weighted': roc_auc_score(y_test, y_prob, multi_class='ovr', average='weighted') if y_prob else 'na',
               'roc_auc_macro': roc_auc_score(y_test, y_prob, multi_class='ovr', average='macro') if y_prob else 'na',
               'roc_auc_micro': roc_auc_score(y_test, y_prob, multi_class='ovr', average='micro') if y_prob else 'na',
