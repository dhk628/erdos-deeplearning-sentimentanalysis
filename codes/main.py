...
if __name__ == '__main__':
    ...
    search_space = {
        ...
        'n_neurons2': 11,
        'weight_decay': 0,
        'input_dropout': 0.24303164896095253,
        'dropout_p1': 0.01768224191826315,
        'dropout_p2': 0.0005341655192253022,
        'max_num_epochs': 200,
        'min_num_epochs': 100,
    ...
    if ray_tune:
        ...
        optuna_search = OptunaSearch(
            ...
            mode="min",
            seed=123,
            # points_to_evaluate=[{'alpha1': 1e-1, 'alpha2': 1e-2}],
        )
        ...
        if not resume:
            ...
            tuner = tune.Tuner.restore(
                path=RAY_RESULTS_PATH + '/' + 'sst5-20240819_231750',
    ...
    # torch.save(trained_model.state_dict(), 'models/sst5/name.pt')
